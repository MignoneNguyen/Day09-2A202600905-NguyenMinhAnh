...
LEGAL_KNOWLEDGE = [
    ...
    {
        "id": "labor_law",
        "keywords": ["lao động", "sa thải", "bồi thường", "hợp đồng lao động", "labor"],
        "text": (
            "Theo Bộ luật Lao động Việt Nam, nếu người sử dụng lao động đơn phương chấm dứt hợp đồng "
            "trái pháp luật thì phải nhận người lao động trở lại làm việc và bồi thường ít nhất 2 tháng tiền lương."
        ),
    },
]
...
def check_statute_of_limitations(case_type: str) -> str:
    """Kiểm tra thời hiệu khởi kiện cho các loại vụ án."""
    case_type = case_type.lower()
    if "hợp đồng" in case_type or "contract" in case_type:
        return "Thời hiệu khởi kiện đối với tranh chấp hợp đồng là 3 năm (theo Bộ luật Dân sự Việt Nam)."
    elif "lao động" in case_type or "labor" in case_type:
        return "Thời hiệu yêu cầu Toà án giải quyết tranh chấp lao động cá nhân là 1 năm."
    else:
